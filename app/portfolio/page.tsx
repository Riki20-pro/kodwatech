      ...
      <section className="pt-32 pb-24 bg-white dark:bg-premium-dark">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            >
              Eksplorasi karya-karya terbaik kami dalam membantu klien mencapai
              kesuksesan digital.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="p-8">
                  <span className="text-primary-purple font-bold text-sm uppercase tracking-widest mb-3 block">
                    {project.category}
                  </span>
                  <h3 className="text-2xl font-bold mb-4 group-hover:text-primary-purple transition-colors">
                    {project.title}
                  </h3>
